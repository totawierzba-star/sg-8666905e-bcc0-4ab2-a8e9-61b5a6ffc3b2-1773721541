    ...
    <Layout>
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="bg-gradient-to-r from-slate-600 to-gray-700 rounded-2xl p-8 text-white text-center">
          <h2 className="text-2xl font-bold mb-3">Przeżywasz stratę bliskiej osoby?</h2>
          <p className="text-slate-200 mb-6">
            Skontaktuj się z nami — pomożemy dobrać wsparcie biblioterapeutyczne
            odpowiednie do Twojej sytuacji lub sytuacji Twojego dziecka.
          </p>
          <Link
            href="/kontakt"
